...
<div class="uk-container uk-container-center uk-width-8-10 uk-text-center uk-margin-top ">
    ...
    <div class="uk-grid uk-align-center uk-width-small-9-10">
        <div class="uk-width-1-3">
            <c:choose>
                <c:when test="${requestScope.isFirstNameNull == false && requestScope.isFirstNameValid == true}">
                    <c:set scope="page" var="firstNameSuccessClass" value="uk-form-success"/>
                </c:when>
                <c:when test="${requestScope.isFirstNameNull == true || requestScope.isFirstNameValid == false}">
        ...
        <div class="uk-width-1-3 ${requestScope.isFirstNameNull == false && requestScope.isFirstNameValid == true ? 'uk-push-1-3' : ''}">
            <c:choose>
                <c:when test="${requestScope.isLastNameNull == false && requestScope.isLastNameValid == true}">
                    <c:set scope="page" var="lastNameSuccessClass" value="uk-form-success"/>
                </c:when>
                <c:when test="${requestScope.isLastNameNull == true || requestScope.isLastNameValid == false}">
                    <div class="uk-alert uk-width-1-1 uk-animation-fade" data-uk-alert>
                        <c:choose>
        ...
        <div class="uk-width-1-3
        ${(requestScope.isLastNameNull == false && requestScope.isLastNameValid == true) && (requestScope.isFirstNameNull == false && requestScope.isFirstNameValid == true) ? 'uk-push-2-3' : ''}
        ${requestScope.isFirstNameNull == false && requestScope.isFirstNameValid == true ? 'uk-push-1-3' : ''}
        ${requestScope.isLastNameNull == false && requestScope.isLastNameValid == true ? 'uk-push-1-3' : ''}">
            <c:choose>
                <c:when test="${requestScope.isPatronymicNull == false && requestScope.isPatronymicValid == true}">
                    <c:set scope="page" var="patronymicSuccessClass" value="uk-form-success"/>
                </c:when>
                <c:when test="${requestScope.isPatronymicNull == true || requestScope.isPatronymicValid == false}">
                    <div class="uk-alert uk-width-1-1 uk-animation-fade" data-uk-alert>
                        <c:choose>
        ...
        <div class="uk-grid uk-align-center uk-margin-bottom-remove uk-margin-top">
            <div class="uk-width-medium-1-2 ">
                ...
                <input aria-labelledby="city-label" id="city" name="city"
                       class="uk-width-1-1
                       ${(requestScope.isCityNull == false && requestScope.isCityValid == true) ||
                       (requestScope.isCityNull == null && requestScope.isCityValid == null) ? 'uk-push-1-2' : ''}
                       uk-form-large uk-form-width-large
                       ${requestScope.isCityNull == true || requestScope.isCityValid == false ? 'uk-form-danger' : ''}
                       ${requestScope.isCityNull == false && requestScope.isCityValid == true ? 'uk-form-success' : ''}"
        ...
        <div class="uk-grid uk-align-center  uk-margin-bottom-remove uk-margin-top">
            <div class="uk-width-medium-1-2 ">
                ...
                <input aria-labelledby="region-label" id="region" name="region"
                       class="uk-width-1-1
                       ${(requestScope.isRegionNull == false && requestScope.isRegionValid == true) ||
                       (requestScope.isRegionNull == null && requestScope.isRegionValid == null) ? 'uk-push-1-2' : ''}
                       uk-form-large uk-form-width-large
                       ${requestScope.isRegionNull == true || requestScope.isRegionValid == false ? 'uk-form-danger' : ''}
                       ${requestScope.isRegionNull == false && requestScope.isRegionValid == true ? 'uk-form-success' : ''}"
                       type="text" value="${requestScope.region}" autocomplete="off" placeholder="Region: ">
            </div>
            <c:if test="${requestScope.isRegionNull == true || requestScope.isRegionValid == false}">
                <div class="uk-width-medium-1-2 uk-animation-fade ">
                    <div class="uk-alert uk-width-1-1 " data-uk-alert>
                        <c:choose>
        ...
        <div class="uk-grid uk-align-center uk-margin-bottom-remove uk-margin-top">
            <div class="uk-width-medium-1-2 ">
                ...
                <input aria-labelledby="accountName-label" id="accountName" name="accountName"
                       class="uk-width-1-1
                       ${(requestScope.isAccountNameNull == false && requestScope.isAccountNameValid == true) && requestScope.isAccountNameExists == false ||
                       (requestScope.isAccountNameNull == null && requestScope.isAccountNameValid == null && requestScope.isAccountNameExists == null) ? 'uk-push-1-2' : ''}
                       uk-form-large uk-form-width-large
                       ${requestScope.isAccountNameNull == true || requestScope.isAccountNameValid == false || requestScope.isAccountNameExists == true ? 'uk-form-danger' : ''}
                       ${requestScope.isAccountNameNull == false && requestScope.isAccountNameValid == true && requestScope.isAccountNameExists == false ? 'uk-form-success' : ''}"
                       type="text" value="${requestScope.accountName}" autocomplete="off" placeholder="Email: ">
            </div>
            <c:if test="${requestScope.isAccountNameNull == true || requestScope.isAccountNameValid == false || requestScope.isAccountNameExists == true}">
                <div class="uk-width-medium-1-2 uk-animation-fade ">
                    <div class="uk-alert uk-width-1-1 " data-uk-alert>
                        <c:choose>
        ...
        <div class="uk-grid uk-align-center uk-margin-bottom-remove uk-margin-top">
            <div class="uk-width-medium-1-2 ">
                ...
                <input aria-labelledby="password-label" id="password" name="password"
                       class="uk-width-1-1
                       ${(requestScope.isPasswordNull == false && requestScope.isPasswordValid == true) ||
                       (requestScope.isPasswordNull == null && requestScope.isPasswordValid == null) ? 'uk-push-1-2' : ''}
                       uk-form-large uk-form-width-large
                       ${requestScope.isPasswordNull == true || requestScope.isPasswordValid == false ? 'uk-form-danger' : ''}
                       ${requestScope.isPasswordNull == false && requestScope.isPasswordValid == true ? 'uk-form-success' : ''} "
                       type="password" autocomplete="off" value="${requestScope.password}" placeholder="Password: ">


            </div>
            <c:if test="${requestScope.isPasswordNull == true || requestScope.isPasswordValid == false}">
                <div class="uk-width-medium-1-2 uk-animation-fade ">
                    <div class="uk-alert uk-width-1-1 " data-uk-alert>
                        <c:choose>
