...
public class FacultiesSorterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<FacultiesInfoAdminBean> facultiesInfoAdminBeans =
                (List<FacultiesInfoAdminBean>) session.getAttribute(SessionAttribute.ADMIN_FACULTIES_INFO_BEANS);
        ...
        if (sortType == null) {
            ...
            switch (sortType) {
                case SORT_TYPE_BY_NAME_ASC:
                    Collections.sort(facultiesInfoAdminBeans, new Comparator<FacultiesInfoAdminBean>() {
                        @Override
                        public int compare(FacultiesInfoAdminBean o1, FacultiesInfoAdminBean o2) {
            ...
            List<FacultiesInfoAdminBean> facultiesInfoAdminBeansSortedPagination = new ArrayList<>();
            copyList(facultiesInfoAdminBeans, facultiesInfoAdminBeansSortedPagination, page, RECORDS_PER_PAGE);
            ...
            session.setAttribute(SessionAttribute.ADMIN_FACULTIES_INFO_BEANS_SORTED, facultiesInfoAdminBeans);
            session.setAttribute(SessionAttribute.ADMIN_FACULTIES_INFO_BEANS_SORTED_PAGINATION, facultiesInfoAdminBeansSortedPagination);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (sortType == null || sortType.equals(SORT_TYPE_NO_SORT)) {
            ...
            List<FacultiesInfoAdminBean> facultiesInfoAdminBeans =
                    (List<FacultiesInfoAdminBean>) session.getAttribute(SessionAttribute.ADMIN_FACULTIES_INFO_BEANS_SORTED);
