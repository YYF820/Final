    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (command) {
            ...
            case COMMAND_RECOVER_PASSWORD:
                MailInfoRecoverPasswordBean mailInfoRecoverPasswordBean = (MailInfoRecoverPasswordBean) request.getAttribute(RequestAttribute.MAIL_INFO_RECOVER_PASSWORD_BEAN);
                firstName = mailInfoRecoverPasswordBean.getFirstName();
                lastName = mailInfoRecoverPasswordBean.getLastName();
                patronymic = mailInfoRecoverPasswordBean.getPatronymic();
                accountName = mailInfoRecoverPasswordBean.getAccountName();
                String ticketRecoverPassword = mailInfoRecoverPasswordBean.getTicketResetPassword();
