...
public class ResendVerificationOrRecoverPasswordServlet extends HttpServlet {
                ...
                if (userRole.equals(ROLE_ADMIN)) {
                    ...
                    switch (entrantStatus) {
                        ...
                        case STATUS_NOT_VERIFIED:
                            ...
                            session.setAttribute(SESSION_ATTRIBUTE_ENTRANT_FOR_VERIFY_ACCOUNT, entrantForResendVerifyMessage);
                            session.setAttribute(SESSION_ATTRIBUTE_USER_FOR_VERIFY_ACCOUNT, userForResendVerifyMessage);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        response.sendRedirect(Pages.RESEND_EMAIL_VERIFICATION_HTML);
    }
