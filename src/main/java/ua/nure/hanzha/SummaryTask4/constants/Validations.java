...
public final class Validations {
    ...
    public static final String MAP_KEY_IS_FIRST_NAME_VALID = "isFirstNameValid";
    public static final String MAP_KEY_IS_LAST_NAME_VALID = "isLastNameValid";
    public static final String MAP_KEY_IS_PATRONYMIC_VALID = "isPatronymicValid";
